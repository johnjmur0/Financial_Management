...
test_that('get_config_field_generic valid', {
  ...
  result = Configuration::get_config_field_generic(test_config, 'Foo')
...
test_that('get_config_field_generic invalid', {
  ...
  expect_error(get_config_field_generic(test_config, 'Foo'), 
...
test_that('get_numeric_field invalid', {
  ...
  expect_error(Configuration::get_numeric_val_from_config(test_config, 'Base_Salary'),
